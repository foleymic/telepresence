...
type InterceptSpec struct {
	...
	// Metadata for storing additional information about the intercept
...
const file_manager_manager_proto_rawDesc = "" +
	...
	"\x02to\x18\x02 \x01(\x05R\x02to\"\xa2\t\n" +
...
var file_manager_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_manager_manager_proto_goTypes = []any{
	...
	nil,                             // 62: telepresence.manager.InterceptInfo.MountsEntry
	nil,                             // 63: telepresence.manager.ReviewInterceptRequest.HeadersEntry
	nil,                             // 64: telepresence.manager.ReviewInterceptRequest.MetadataEntry
	nil,                             // 65: telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	nil,                             // 66: telepresence.manager.ReviewInterceptRequest.MountsEntry
	nil,                             // 67: telepresence.manager.LogsResponse.PodLogsEntry
	nil,                             // 68: telepresence.manager.LogsResponse.PodYamlEntry
	(*WorkloadInfo_Intercept)(nil),  // 69: telepresence.manager.WorkloadInfo.Intercept
...
var file_manager_manager_proto_depIdxs = []int32{
	...
	59, // 7: telepresence.manager.InterceptInfo.headers:type_name -> telepresence.manager.InterceptInfo.HeadersEntry
	60, // 8: telepresence.manager.InterceptInfo.metadata:type_name -> telepresence.manager.InterceptInfo.MetadataEntry
	61, // 9: telepresence.manager.InterceptInfo.environment:type_name -> telepresence.manager.InterceptInfo.EnvironmentEntry
	62, // 10: telepresence.manager.InterceptInfo.mounts:type_name -> telepresence.manager.InterceptInfo.MountsEntry
	70, // 11: telepresence.manager.InterceptInfo.modified_at:type_name -> google.protobuf.Timestamp
	12, // 12: telepresence.manager.ReconnectAgentRequest.session:type_name -> telepresence.manager.SessionInfo
	6,  // 13: telepresence.manager.ReconnectAgentRequest.agent:type_name -> telepresence.manager.AgentInfo
	12, // 14: telepresence.manager.ReconnectClientRequest.session:type_name -> telepresence.manager.SessionInfo
	5,  // 15: telepresence.manager.ReconnectClientRequest.client:type_name -> telepresence.manager.ClientInfo
	9,  // 16: telepresence.manager.ReconnectClientRequest.intercepts:type_name -> telepresence.manager.InterceptInfo
	6,  // 17: telepresence.manager.ReconnectClientRequest.agents:type_name -> telepresence.manager.AgentInfo
	12, // 18: telepresence.manager.AgentsRequest.session:type_name -> telepresence.manager.SessionInfo
	...
	63, // 28: telepresence.manager.ReviewInterceptRequest.headers:type_name -> telepresence.manager.ReviewInterceptRequest.HeadersEntry
	64, // 29: telepresence.manager.ReviewInterceptRequest.metadata:type_name -> telepresence.manager.ReviewInterceptRequest.MetadataEntry
	65, // 30: telepresence.manager.ReviewInterceptRequest.environment:type_name -> telepresence.manager.ReviewInterceptRequest.EnvironmentEntry
	66, // 31: telepresence.manager.ReviewInterceptRequest.mounts:type_name -> telepresence.manager.ReviewInterceptRequest.MountsEntry
	12, // 32: telepresence.manager.RemainRequest.session:type_name -> telepresence.manager.SessionInfo
	71, // 33: telepresence.manager.LogLevelRequest.duration:type_name -> google.protobuf.Duration
	67, // 34: telepresence.manager.LogsResponse.pod_logs:type_name -> telepresence.manager.LogsResponse.PodLogsEntry
	68, // 35: telepresence.manager.LogsResponse.pod_yaml:type_name -> telepresence.manager.LogsResponse.PodYamlEntry
	...
	32, // 39: telepresence.manager.DNSAgentResponse.request:type_name -> telepresence.manager.DNSRequest
	33, // 40: telepresence.manager.DNSAgentResponse.response:type_name -> telepresence.manager.DNSResponse
	35, // 41: telepresence.manager.ClusterInfo.service_subnet:type_name -> telepresence.manager.IPNet
	35, // 42: telepresence.manager.ClusterInfo.pod_subnets:type_name -> telepresence.manager.IPNet
	37, // 43: telepresence.manager.ClusterInfo.routing:type_name -> telepresence.manager.Routing
	38, // 44: telepresence.manager.ClusterInfo.dns:type_name -> telepresence.manager.DNS
	35, // 45: telepresence.manager.Routing.also_proxy_subnets:type_name -> telepresence.manager.IPNet
	35, // 46: telepresence.manager.Routing.never_proxy_subnets:type_name -> telepresence.manager.IPNet
	35, // 47: telepresence.manager.Routing.allow_conflicting_subnets:type_name -> telepresence.manager.IPNet
	41, // 48: telepresence.manager.AgentPodInfoSnapshot.agents:type_name -> telepresence.manager.AgentPodInfo
	...
	69, // 53: telepresence.manager.WorkloadInfo.intercept_clients:type_name -> telepresence.manager.WorkloadInfo.Intercept
	...
	47, // 56: telepresence.manager.WorkloadEvent.workload:type_name -> telepresence.manager.WorkloadInfo
	70, // 57: telepresence.manager.WorkloadEventsDelta.since:type_name -> google.protobuf.Timestamp
	48, // 58: telepresence.manager.WorkloadEventsDelta.events:type_name -> telepresence.manager.WorkloadEvent
	12, // 59: telepresence.manager.WorkloadEventsRequest.session_info:type_name -> telepresence.manager.SessionInfo
	70, // 60: telepresence.manager.WorkloadEventsRequest.since:type_name -> google.protobuf.Timestamp
	12, // 61: telepresence.manager.UninstallAgentsRequest.session_info:type_name -> telepresence.manager.SessionInfo
	55, // 62: telepresence.manager.AgentInfo.ContainerInfo.environment:type_name -> telepresence.manager.AgentInfo.ContainerInfo.EnvironmentEntry
	56, // 63: telepresence.manager.AgentInfo.ContainerInfo.mounts:type_name -> telepresence.manager.AgentInfo.ContainerInfo.MountsEntry
	53, // 64: telepresence.manager.AgentInfo.ContainersEntry.value:type_name -> telepresence.manager.AgentInfo.ContainerInfo
	72, // 65: telepresence.manager.Manager.Version:input_type -> google.protobuf.Empty
	72, // 66: telepresence.manager.Manager.GetAgentImageFQN:input_type -> google.protobuf.Empty
	43, // 67: telepresence.manager.Manager.GetAgentConfig:input_type -> telepresence.manager.AgentConfigRequest
	72, // 68: telepresence.manager.Manager.GetClientConfig:input_type -> google.protobuf.Empty
	72, // 69: telepresence.manager.Manager.GetTelepresenceAPI:input_type -> google.protobuf.Empty
	5,  // 70: telepresence.manager.Manager.ArriveAsClient:input_type -> telepresence.manager.ClientInfo
	10, // 71: telepresence.manager.Manager.ReconnectAgent:input_type -> telepresence.manager.ReconnectAgentRequest
	11, // 72: telepresence.manager.Manager.ReconnectClient:input_type -> telepresence.manager.ReconnectClientRequest
	6,  // 73: telepresence.manager.Manager.ArriveAsAgent:input_type -> telepresence.manager.AgentInfo
	22, // 74: telepresence.manager.Manager.Remain:input_type -> telepresence.manager.RemainRequest
	12, // 75: telepresence.manager.Manager.Depart:input_type -> telepresence.manager.SessionInfo
	23, // 76: telepresence.manager.Manager.SetLogLevel:input_type -> telepresence.manager.LogLevelRequest
	24, // 77: telepresence.manager.Manager.GetLogs:input_type -> telepresence.manager.GetLogsRequest
	12, // 78: telepresence.manager.Manager.WatchAgentPods:input_type -> telepresence.manager.SessionInfo
	12, // 79: telepresence.manager.Manager.WatchAgents:input_type -> telepresence.manager.SessionInfo
	12, // 80: telepresence.manager.Manager.WatchIntercepts:input_type -> telepresence.manager.SessionInfo
	50, // 81: telepresence.manager.Manager.WatchWorkloads:input_type -> telepresence.manager.WorkloadEventsRequest
	12, // 82: telepresence.manager.Manager.WatchClusterInfo:input_type -> telepresence.manager.SessionInfo
	17, // 83: telepresence.manager.Manager.EnsureAgent:input_type -> telepresence.manager.EnsureAgentRequest
	16, // 84: telepresence.manager.Manager.PrepareIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	16, // 85: telepresence.manager.Manager.CreateIntercept:input_type -> telepresence.manager.CreateInterceptRequest
	19, // 86: telepresence.manager.Manager.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	20, // 87: telepresence.manager.Manager.GetIntercept:input_type -> telepresence.manager.GetInterceptRequest
	21, // 88: telepresence.manager.Manager.ReviewIntercept:input_type -> telepresence.manager.ReviewInterceptRequest
	12, // 89: telepresence.manager.Manager.GetKnownWorkloadKinds:input_type -> telepresence.manager.SessionInfo
	30, // 90: telepresence.manager.Manager.Lookup:input_type -> telepresence.manager.LookupRequest
	32, // 91: telepresence.manager.Manager.LookupDNS:input_type -> telepresence.manager.DNSRequest
	72, // 92: telepresence.manager.Manager.WatchLogLevel:input_type -> google.protobuf.Empty
	28, // 93: telepresence.manager.Manager.Tunnel:input_type -> telepresence.manager.TunnelMessage
	45, // 94: telepresence.manager.Manager.ReportMetrics:input_type -> telepresence.manager.TunnelMetrics
	51, // 95: telepresence.manager.Manager.UninstallAgents:input_type -> telepresence.manager.UninstallAgentsRequest
	27, // 96: telepresence.manager.Manager.Version:output_type -> telepresence.manager.VersionInfo2
	40, // 97: telepresence.manager.Manager.GetAgentImageFQN:output_type -> telepresence.manager.AgentImageFQN
	44, // 98: telepresence.manager.Manager.GetAgentConfig:output_type -> telepresence.manager.AgentConfigResponse
	39, // 99: telepresence.manager.Manager.GetClientConfig:output_type -> telepresence.manager.CLIConfig
	26, // 100: telepresence.manager.Manager.GetTelepresenceAPI:output_type -> telepresence.manager.TelepresenceAPIInfo
	12, // 101: telepresence.manager.Manager.ArriveAsClient:output_type -> telepresence.manager.SessionInfo
	72, // 102: telepresence.manager.Manager.ReconnectAgent:output_type -> google.protobuf.Empty
	72, // 103: telepresence.manager.Manager.ReconnectClient:output_type -> google.protobuf.Empty
	12, // 104: telepresence.manager.Manager.ArriveAsAgent:output_type -> telepresence.manager.SessionInfo
	72, // 105: telepresence.manager.Manager.Remain:output_type -> google.protobuf.Empty
	72, // 106: telepresence.manager.Manager.Depart:output_type -> google.protobuf.Empty
	72, // 107: telepresence.manager.Manager.SetLogLevel:output_type -> google.protobuf.Empty
	25, // 108: telepresence.manager.Manager.GetLogs:output_type -> telepresence.manager.LogsResponse
	42, // 109: telepresence.manager.Manager.WatchAgentPods:output_type -> telepresence.manager.AgentPodInfoSnapshot
	14, // 110: telepresence.manager.Manager.WatchAgents:output_type -> telepresence.manager.AgentInfoSnapshot
	15, // 111: telepresence.manager.Manager.WatchIntercepts:output_type -> telepresence.manager.InterceptInfoSnapshot
	49, // 112: telepresence.manager.Manager.WatchWorkloads:output_type -> telepresence.manager.WorkloadEventsDelta
	36, // 113: telepresence.manager.Manager.WatchClusterInfo:output_type -> telepresence.manager.ClusterInfo
	...
	9,  // 116: telepresence.manager.Manager.CreateIntercept:output_type -> telepresence.manager.InterceptInfo
	72, // 117: telepresence.manager.Manager.RemoveIntercept:output_type -> google.protobuf.Empty
	9,  // 118: telepresence.manager.Manager.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	72, // 119: telepresence.manager.Manager.ReviewIntercept:output_type -> google.protobuf.Empty
	46, // 120: telepresence.manager.Manager.GetKnownWorkloadKinds:output_type -> telepresence.manager.KnownWorkloadKinds
	31, // 121: telepresence.manager.Manager.Lookup:output_type -> telepresence.manager.LookupResponse
	33, // 122: telepresence.manager.Manager.LookupDNS:output_type -> telepresence.manager.DNSResponse
	23, // 123: telepresence.manager.Manager.WatchLogLevel:output_type -> telepresence.manager.LogLevelRequest
	28, // 124: telepresence.manager.Manager.Tunnel:output_type -> telepresence.manager.TunnelMessage
	72, // 125: telepresence.manager.Manager.ReportMetrics:output_type -> google.protobuf.Empty
	72, // 126: telepresence.manager.Manager.UninstallAgents:output_type -> google.protobuf.Empty
